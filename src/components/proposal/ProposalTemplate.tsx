                ...
                <main className="pt-24 pb-16 px-5 md:px-12 max-w-5xl mx-auto">
                    ...
                    <section className="mb-32 pt-12 relative">
                        <div className="flex items-center gap-4 mb-8">
                            <span className="text-switz-red text-xs font-bold tracking-[0.4em] uppercase animate-fade-in border border-switz-red/20 px-3 py-1 rounded-full bg-switz-red/5">
                    ...
                    <section className="mb-32">
                        <div className="relative aspect-[21/9] w-full overflow-hidden rounded-sm mb-4 group shadow-2xl">
                            ...
                            <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
                                <div>
                                    <span className="text-switz-red text-xs font-bold tracking-[0.4em] uppercase mb-2 block animate-pulse">Peak State</span>
                                    <h3 className="text-3xl md:text-4xl font-serif text-white italic">Glacier 3000.</h3>
                                </div>
                                <span className="text-xs uppercase tracking-widest text-white/40 hidden md:block">Real Swiss Peaks</span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-32">
                        <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-white/40 mb-12 border-b border-white/10 pb-4 flex justify-between items-center group">
                            ...
                            <a href="/sanctuaries/villars" target="_blank" className="text-xs uppercase tracking-widest text-switz-red hover:text-white transition-colors flex items-center gap-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:h-[650px]">
                            <div className="md:col-span-8 relative overflow-hidden rounded-sm group h-[400px] md:h-full">
                                ...
                                <div className="absolute bottom-12 left-12">
                                    <span className="text-switz-red text-xs font-bold tracking-[0.3em] uppercase block mb-3">Atmosphere</span>
                            ...
                            <div className="md:col-span-4 flex flex-col gap-4">
                                <div className="flex-1 relative overflow-hidden rounded-sm group min-h-[220px]">
                                    ...
                                    <div className="absolute top-4 right-4 bg-black/40 backdrop-blur-md px-2 py-1 text-xs uppercase tracking-widest text-white/80">
                                        Curated Space
                                    </div>
                                </div>
                                <div className="flex-1 relative overflow-hidden rounded-sm group min-h-[220px]">
                                    ...
                                    <div className="absolute bottom-4 left-4">
                                        <span className="text-white/40 text-xs uppercase tracking-widest italic group-hover:text-switz-red transition-colors">Wood Fireplace</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
                            <div className="bg-white/5 border border-white/10 p-6 rounded-sm hover:border-switz-red/30 transition-colors">
                                <span className="text-switz-red text-xs font-bold uppercase tracking-widest block mb-2">Marshall Sound</span>
                                <p className="text-xs text-white/50 leading-relaxed font-light">Fidelidade sonora absoluta em todos os ambientes.</p>
                            </div>
                            <div className="bg-white/5 border border-white/10 p-6 rounded-sm hover:border-switz-red/30 transition-colors">
                                <span className="text-switz-red text-xs font-bold uppercase tracking-widest block mb-2">Cozinha Design</span>
                                <p className="text-xs text-white/50 leading-relaxed font-light">Equipada para o ritual de nutrição de montanha.</p>
                            </div>
                            <div className="bg-white/5 border border-white/10 p-6 rounded-sm hover:border-switz-red/30 transition-colors">
                                <span className="text-switz-red text-xs font-bold uppercase tracking-widest block mb-2">High Speed WiFi</span>
                                <p className="text-xs text-white/50 leading-relaxed font-light">Conexão estável para qualquer necessidade remota.</p>
                            </div>
                            <a href="/sanctuaries/villars" target="_blank" className="bg-switz-red/10 border border-switz-red/30 p-6 rounded-sm flex flex-col items-center justify-center group cursor-pointer transition-all hover:bg-switz-red/20">
                                <span className="text-xs uppercase tracking-[0.2em] text-switz-red font-bold">Resort Residence</span>
                                <span className="text-xs uppercase tracking-widest text-white/40 group-hover:text-white transition-colors mt-1 flex items-center gap-2">View Full Specs <ArrowRight className="w-2 h-2" /></span>
                            </a>
                        </div>
                    </section>
                    ...
                    <section className="mb-32">
                        <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-white/40 mb-12 border-b border-white/10 pb-4 flex justify-between items-center">
                            ...
                            <span className="text-xs font-normal lowercase tracking-normal">Real Swiss Experiences</span>
                        </h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div className="group cursor-pointer" onClick={() => window.open('/journals', '_blank')}>
                                ...
                                <span className="text-switz-red text-xs font-bold uppercase tracking-[0.3em] block mb-3 group-hover:translate-x-1 transition-transform">The Alpine Protocol // Ale & Alex</span>
                            ...
                            <div className="group cursor-pointer" onClick={() => window.open('/journals', '_blank')}>
                                ...
                                <span className="text-switz-red text-xs font-bold uppercase tracking-[0.3em] block mb-3 group-hover:translate-x-1 transition-transform">The Winter Ascent // Wagner & Family</span>
                                <p className="text-white/60 text-base font-light leading-relaxed italic border-l border-switz-red/30 pl-4">
                        ...
                        <div className="md:col-span-4 space-y-16">
                            <div>
                                ...
                                <div className="p-6 bg-white/5 border border-white/10 rounded-sm hover:border-switz-red/20 transition-all">
                                    ...
                                    <span className="text-xs text-white/40 uppercase tracking-widest mt-2 block">A reserva bloqueia imediatamente o Loft</span>
                                </div>
                            </div>
                            ...
                            <div>
                                    ...
                                    {config.pricing.tiers.map((tier) => (
                                        ...
                                        >
                                            <div className="relative z-10 flex items-center gap-5">
                                                ...
                                                <div>
                                                    <span className={cn("text-xs font-bold tracking-[0.2em] uppercase block mb-1", selectedTier === tier.total ? "text-switz-red" : "text-white/40")}>
                                                        {tier.label}
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="text-right relative z-10">
                                                <span className="block text-white font-serif text-xl tracking-tighter italic">{currency}{tier.price} <small className="text-xs text-white/30 lowercase tracking-widest font-sans not-italic">/pp</small></span>
                                            </div>
                                            {selectedTier === tier.total && (
                                ...
                                <div className="mt-6 p-4 bg-white/5 border border-white/10 rounded-sm space-y-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-white/40 uppercase tracking-widest font-bold">Logística da Residência</span>
                                    </div>
                                    <p className="text-xs text-white/33 leading-relaxed font-light italic">
                                ...
                                <div className="space-y-6">
                                    {config.pricing.addOns.map((addon) => (
                                        ...
                                        >
                                            ...
                                            <p className="text-xs text-white/40 font-light leading-relaxed relative z-10">{addon.description}</p>
                                            <div className={cn(
                        ...
                        <div className="md:col-span-8 space-y-24">
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 p-10 bg-white/5 border border-white/10 rounded-sm relative overflow-hidden group">
                                ...
                                <div className="space-y-2 relative z-10">
                                    <span className="text-xs uppercase tracking-widest text-switz-red font-bold">Transfer</span>
                                    <p className="text-sm text-white/80 font-serif italic">Private Luxury SUV</p>
                                </div>
                                <div className="space-y-2 relative z-10">
                                    <span className="text-xs uppercase tracking-widest text-switz-red font-bold">Safe Zone</span>
                                    <p className="text-sm text-white/80 font-serif italic">Portuguese Host</p>
                                </div>
                                <div className="space-y-2 relative z-10">
                                    <span className="text-xs uppercase tracking-widest text-switz-red font-bold">Artifacts</span>
                                    <p className="text-sm text-white/80 font-serif italic">High-End Photo/Video</p>
                                </div>
                                <div className="space-y-2 relative z-10">
                                    <span className="text-xs uppercase tracking-widest text-switz-red font-bold">The Loft</span>
                            ...
                            <div className="relative pl-0 md:pl-16 border-l-0 md:border-l border-white/5 group">
                                ...
                                <span className="text-xs uppercase tracking-[0.4em] text-switz-red md:text-white/40 mb-6 block font-bold group-hover:text-switz-red transition-colors">Day 01 // The Reset</span>
                                            ...
                                            <div className="relative h-full flex flex-col group/item">
                                                ...
                                                <div className="aspect-[3/4] overflow-hidden rounded-sm mb-8 relative">
                                                    ...
                                                    <div className="absolute bottom-6 left-6 right-6">
                                                        <span className="text-switz-red text-xs font-bold tracking-[0.3em] uppercase block mb-2">Arrival</span>
                            ...
                            <div className="relative pl-16 border-l border-white/10 group">
                                ...
                                <span className="text-xs uppercase tracking-[0.4em] text-white/40 mb-6 block font-bold">Day 02 // The Peak State</span>
                    ...
                    <section className="mb-32 grid grid-cols-1 md:grid-cols-12 gap-16 items-center border-t border-white/10 pt-32">
                        <div className="md:col-span-12 lg:col-span-5 relative group">
                            ...
                            <div className="absolute -bottom-8 -right-8 bg-neutral-900 p-10 border border-white/10 hidden md:block text-right shadow-2xl backdrop-blur-md bg-opacity-95">
                                <span className="text-switz-red text-xs font-bold tracking-[0.4em] uppercase block mb-3">Host & Arquiteto</span>
                        ...
                        <div className="md:col-span-12 lg:col-start-7 lg:col-span-6 space-y-10">
                            <div>
                                <span className="text-switz-red text-xs font-bold tracking-[0.4em] uppercase block mb-6">Host Residency</span>
                            ...
                            <div className="p-8 bg-switz-red/5 border border-switz-red/20 rounded-sm">
                                <p className="text-switz-red text-xs font-bold uppercase tracking-[0.3em] mb-4 flex items-center gap-3">
                    ...
                    <section id="investment" className="bg-neutral-900 border border-white/5 p-6 md:p-20 mb-24 relative overflow-hidden group rounded-sm shadow-3xl">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 relative z-10">
                            <div>
                                <span className="text-switz-red text-xs font-bold tracking-[0.4em] uppercase block mb-6 md:mb-10">
                                ...
                                <div className="mb-12 md:mb-16">
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
                                        ...
                                        <span className="text-switz-red text-xs font-bold uppercase tracking-[0.3em] bg-switz-red/10 border border-switz-red/20 px-4 py-2 inline-flex items-center gap-3 w-fit">
                                ...
                                <div className="mt-10 flex flex-col items-center gap-6">
                                    <p className="text-xs text-white/35 uppercase tracking-[0.3em] italic text-center leading-relaxed">A emissão da invoice formal ocorre após a <br /> reserva do depósito de compromisso.</p>
                                    <a
                                        href={config.contact.whatsapp}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-xs text-white/40 hover:text-switz-red transition-all duration-500 uppercase tracking-[0.4em] border-b border-white/5 hover:border-switz-red pb-2 font-bold"
                                    >
                            ...
                            <div className="hidden lg:flex flex-col justify-center">
                                <div className="p-16 bg-white/5 border border-white/10 rounded-sm backdrop-blur-md relative overflow-hidden group/card hover:border-switz-red/30 transition-all duration-1000 shadow-3xl">
                                    ...
                                    <ul className="space-y-8">
                                        <li className="flex items-center gap-6 text-white/40 text-xs tracking-[0.3em] uppercase font-bold group-hover:text-white/60 transition-colors">
                                    ...
                                    <div className="mt-20 flex justify-between items-end border-t border-white/5 pt-10">
                                        ...
                                        <div className="flex flex-col items-end gap-3">
                                            <span className="text-xs text-white/10 uppercase tracking-[0.5em]">Swiss Quality</span>
