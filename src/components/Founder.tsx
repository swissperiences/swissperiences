            ...
            <div className="max-w-7xl mx-auto">
                ...
                />
                            ...
                            <div className="absolute bottom-6 left-6 z-20 flex flex-col gap-1">
                                <span className="text-xs text-white/40 uppercase tracking-[0.2em] font-sans">Location Log</span>
                    ...
                    <div className="w-full md:w-7/12 space-y-12">
                        <ScrollReveal variant="slideUp" delay={0.2}>
                            <span className="text-switz-red text-xs font-bold tracking-[0.3em] uppercase block mb-6">
                                {t('founder.heading')}
                            </span>
                            <h2 className="text-4xl md:text-5xl lg:text-7xl font-serif text-white leading-[1.1] mb-4">
                                {t('founder.title')}
                            </h2>
                            <p className="font-sans uppercase tracking-[0.2em] text-xs md:text-xs text-white/60">
                                {t('founder.subtitle')}
                            </p>
                        </ScrollReveal>
                        ...
                        <ScrollReveal variant="fade" delay={0.7} className="pt-8 flex flex-wrap gap-x-12 gap-y-8">
                            <div className="group">
                                <p className="text-xs text-switz-red uppercase tracking-[0.2em] mb-2">{t('founder.locationSub')}</p>
                            ...
                            <div className="group">
                                <p className="text-xs text-switz-red uppercase tracking-[0.2em] mb-2">{t('founder.retreatSub')}</p>
