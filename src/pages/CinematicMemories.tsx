...
export default function CinematicMemories() {
    ...
    const galleryItems = [
        ...
        { src: "/images/drone/villars-autumn-sunset.jpg", label: "Golden Hour", span: "col-span-1 row-span-2" },
        { src: "/images/drone/lake-brienz-aerial.jpg", label: t('cinematic.gallery.nature'), span: "col-span-1" },
    ...
    return (
        <div className="bg-neutral-950 min-h-screen text-white pb-24">
            <SEO
                ...
                canonical="https://www.swissperiences.ch/experiences/cinematic-memories"
